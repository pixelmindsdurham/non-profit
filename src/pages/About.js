  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      ...
      <section>
        ...
        <blockquote className="italic border-l-4 border-blue-700 pl-4 mb-2">“Pixel Minds changed my child’s life!” – Parent</blockquote>
